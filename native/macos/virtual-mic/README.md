# Sonora Mix para macOS

Dispositivo Core Audio virtual que encaminha sua saída para uma entrada de áudio com o mesmo nome.
Assim, o Sonora Connect mistura voz e áudios em `Sonora Mix` e Zoom, Meet, Discord ou outro
...
aplica somente a identidade do Sonora e o loopback, compila e assina ad-hoc o bundle. Ele não instala
