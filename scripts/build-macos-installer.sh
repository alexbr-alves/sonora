...
package_root=$(mktemp -d /private/tmp/sonora-installer-root.XXXXXX)
...
COPYFILE_DISABLE=1 ditto --noextattr --norsrc "$app" "$package_root/Applications/Sonora Connect.app"
...
pkgbuild \
  ...
  "$project_dir/release/Sonora.pkg"
